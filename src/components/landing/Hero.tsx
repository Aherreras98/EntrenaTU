        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Link to="/signup" className="w-full sm:w-auto">
              <Button
                className="group relative text-lg px-8 py-4 w-full sm:w-auto transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-110 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(255,87,51,0.6)] active:scale-95 overflow-hidden animate-shine"
              >
            ...
            <Link to="/login" className="w-full sm:w-auto">
              <Button
                variant="secondary"
                className="text-lg px-8 py-4 w-full sm:w-auto border-zinc-800 text-zinc-500 font-medium transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-110 hover:text-zinc-200 hover:border-zinc-600 active:scale-95"
              >
